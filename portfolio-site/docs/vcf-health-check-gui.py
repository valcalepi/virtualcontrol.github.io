...
class VCFHealthCheckApp:
    ...
    def _show_help(self):
        ...
        _section(scroll_frame, "Step 5: See Your Results (Dashboard)",
            ...
            "If you have more than one profile, you will see an Environment Overview "
            "with cards for each one. Each card shows:\n"
            "  - The profile name and environment label\n"
            "  - A color-coded grade badge\n"
            "  - Pass / Warning / Failure counts from the last run\n"
            "  - A colored left border matching the grade (green for A, red for F)\n\n"
            "Click any card to jump straight to that environment.")
        ...
        _section(scroll_frame, "Extra Features",
            ...
            "  Note: Requires a Professional or Enterprise license.\n\n"
            "Customer Branding (Professional+):\n"
            "  In the Environment page, expand the Customer Branding section to set:\n"
            "  - Company Name: Appears in the HTML report header and footer.\n"
            "  - Company Logo: Browse to a PNG, JPG, or SVG file (max 500 KB).\n"
            "    The logo is embedded directly in the HTML report next to the title.\n"
            "  - Environment Label: A custom name for this environment.\n"
            "  Note: Requires a Professional or Enterprise license. "
            "Standard tier users will see a locked section.\n\n"
            "License Tiers:\n"
            "  Some features are only available on higher license tiers:\n"
            "  - Standard: Core health checks, up to 5 environments.\n"
            "  - Professional: Adds customer branding, scheduled runs, up to 25 environments.\n"
            "  - Enterprise: Adds API export, usage analytics, white-label, up to 100 environments.\n"
            "  Locked features show a lock icon and the required tier.\n\n"
            "Dark Mode:\n"
